...
export default function ModalPlayMagnate({
  setModalTypeCard,
  gameState,
  myPlayer,
}: Props) {
  ...
  const onPlayMagnate = () => {
    ...
    emitEvent(CLIENT_EVENTS.GAME_PLAY_MAGNATE, {
  ...
  const onPlayMagnateWithoutEffect = () => {
    emitEvent(CLIENT_EVENTS.GAME_PLAY_WITHOUT_EFFECT, {
      cardPlayed: NAME_CARD.MAGNATE,
    });
    ...
    <ModalTemplate>
      <div className="flex flex-col items-center gap-2 text-center sm:gap-3 md:gap-6">
        ...
        {gameState?.players.filter((p) => {
          ...
          <>
            ...
            <div className="flex flex-col items-center gap-2 sm:flex-row">
              <PrimaryButton
                ...
                onClick={onPlayMagnateWithoutEffect}
              />
              <SecondaryButton
                buttonText="Retour"
                onClick={() => {
          ...
          <>
            <p className="text-xs sm:text-sm">
              Sélectionnez le joueur avec lequel vous voulez comparer votre
              seconde carte
            </p>
            <PlayerSelector
            ...
            <div className="flex flex-col items-center gap-2 sm:flex-row">
              <PrimaryButton buttonText="Comparer" onClick={onPlayMagnate} />
              <SecondaryButton
                buttonText="Retour"
                onClick={() => {
                  setModalTypeCard(null);
